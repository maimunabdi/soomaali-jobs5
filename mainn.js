...
const jobs = [
    ...
    { title: "Technology and Programming", location: "Hargeisa", company: "Hormuuda", description: "Software development, internet service IT companies, media and content creation", category: "technology", image: "./images/tecnolo.jpg" },
    { title: "Agriculture and Livestock", location: "Mudug", company: "SATG", description: "Farming, livestock care and trade, fishing", category: "agriculture", image: "./images/agricul.jpg" },
    { title: "Skilled Trades", location: "Garowe", company: "Simad iLab", description: "Construction and building maintenance, electrical work and vehicle mechanics, furniture making", category: "skilled-trades", image: "./images/skill.jpg" },
    { title: "Business and Marketing", location: "Mogadishu", company: "SBH", description: "Small-scale businesses and shops, marketing of goods and service, tourism and hospitality services", category: "business", image: "./images/marketing.jpg" },
    { title: "arts", category: "arts", location: "mogadisho", description: " art and photography, interior decoration.",image: "./images/arts.jpg" },
    { title: "Community Services and International Organization", location: "Hargeisa", company: "Bilan Group", description: "Nonprofit and humanitarian organization, training and community services roles, development project", category: "community", image: "./images/community.jpg" },
    { title: "Government Jobs", location: "Mogadishu", company: "Somali Ports Authority", description: "Teachers, police and military, administrative roles in government offices", category: "government", image: "./images/government.jpg" },
    { title: "Health Care Jobs", location: "Mogadishu", company: "Deva Hospital", description: "Doctors and nurses, pharmacists, public health and sanitation service", category: "health", image: "./images/health.jpg" },
    { title: "Beauty and Arts", location: "Mogadishu", company: "BPS", description: "Beauty service(salons), art and photography, interior decoration", category: "beauty", image: "./images/beauty.jpg" },
    { title: "High School Teacher", category: "Education", location: "Mogadishu", description: "Teach students in secondary school, prepare lesson plans, and assess student progress." ,image: "./images/school.jpeg"},
    { title: "General Doctor", category: "general-doctor", location: "Hargeisa", description: "Provide general medical care to patients, including diagnosis, treatment, and preventive care.",image: "./images/General..jpeg" },
    { title: "Software Engineer", category: "software", location: "Garowe", description: "Develop software applications, write clean and efficient code, and maintain systems." ,image: "./images/Software.jpeg"},
    { title: "Financial Accountant", category: "Finance", location: "Kismayo", description: "Manage financial records, prepare reports, and ensure the accuracy of financial transactions.",image: "./images/Financial .jpeg" },
    { title: "Construction Engineer", category: "Construction", location: "Baydhabo", description: "Oversee construction projects, manage teams, and ensure projects meet safety and quality standards." ,image: "./images/construcyion.jpeg"},
    { title: "Security Officer", category: "Security", location: "Boosaaso", description: "Ensure the safety and security of property and individuals, conduct security checks, and monitor surveillance systems.",image: "./images/securaty.jpeg" }
